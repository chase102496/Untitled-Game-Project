function scrEntityStateInit()
{
	...
	snowState.add("Free",{
			...
			draw: function()
			{
				draw_sprite_ext(sprite_index,image_index,round(x),round(y),stats.xScale,stats.yScale,image_angle,make_color_hsv(stats.spriteColor[0],stats.spriteColor[1],stats.spriteColor[2]),image_alpha);
			},
			animation: function()
			{
				scrColorChange();
